...
class Resnet18MRIADCT2DWIRoImage(nn.Module):
    ...
    def __init__(self, out_channel=128):
        ...
        self.adc_feat_extractor = resnet18(pretrained=False, num_classes=out_channel)
        ...
        self.t2_feat_extractor = resnet18(pretrained=False, num_classes=out_channel)
        self.t2_head = nn.Sequential(*[
            nn.Linear(out_channel, 1),
            nn.Sigmoid()
        ])

        self.dwi_feat_extractor = resnet18(pretrained=False, num_classes=out_channel)
